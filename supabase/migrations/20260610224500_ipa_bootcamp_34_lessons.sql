...
values
  ...
  (3, 'diphthongs-nguyen-am-doi', 'Diphthongs – Nguyên âm đôi', 'Diphthongs – Nguyên âm đôi', 'Học cách đọc âm trượt', 'Nguyên âm đôi', 'ready', '{"module":"ipa-bootcamp","ipa":{"learningItems":"/eɪ/ /aɪ/ /ɔɪ/ /aʊ/ /əʊ/ /ɪə/ /eə/ /ʊə/"}}'::jsonb, '[]'::jsonb),
  (4, 'stop-sounds-and-nasals', 'Stop Sounds & Nasals – Âm bật và âm mũi', 'Stop Sounds & Nasals – Âm bật và âm mũi', 'Bật âm rõ, không nuốt âm cuối', 'Phụ âm bật + âm mũi', 'ready', '{"module":"ipa-bootcamp","ipa":{"learningItems":"/p/ /b/ /t/ /d/ /k/ /g/ /m/ /n/ /ŋ/"}}'::jsonb, '[]'::jsonb),
  (5, 'fricatives-am-gio-am-ma-sat', 'Fricatives – Âm gió / âm ma sát', 'Fricatives – Âm gió / âm ma sát', 'Phân biệt hơi và rung giọng', 'Phụ âm gió / ma sát', 'ready', '{"module":"ipa-bootcamp","ipa":{"learningItems":"/f/ /v/ /θ/ /ð/ /s/ /z/ /ʃ/ /ʒ/ /h/"}}'::jsonb, '[]'::jsonb),
  (6, 'difficult-consonants', 'Difficult Consonants – Âm dễ sai với người Việt', 'Difficult Consonants – Âm dễ sai với người Việt', 'Sửa lỗi ch, j, l, r, w, y', 'Âm ch, j, l, r, w, y', 'ready', '{"module":"ipa-bootcamp","ipa":{"learningItems":"/tʃ/ /dʒ/ /l/ /r/ /w/ /j/"}}'::jsonb, '[]'::jsonb),
  (7, 'word-stress-and-schwa', 'Word Stress & Schwa – Trọng âm và âm /ə/', 'Word Stress & Schwa – Trọng âm và âm /ə/', 'Biết vì sao tiếng Anh không đọc đều từng chữ', 'Trọng âm + âm schwa', 'ready', '{"module":"ipa-bootcamp","ipa":{"learningItems":"word stress, syllable, /ə/"}}'::jsonb, '[]'::jsonb),
  (8, 'ipa-review-tong-on', 'IPA Review – Tổng ôn IPA và đọc từ/câu', 'IPA Review – Tổng ôn IPA và đọc từ/câu', 'Tổng ôn 44 âm + đọc từ + đọc câu', 'Tổng ôn IPA + đọc từ/câu', 'ready', '{"module":"ipa-bootcamp","ipa":{"learningItems":"44 âm + đọc 50 từ + 20 câu"}}'::jsonb, '[]'::jsonb)
