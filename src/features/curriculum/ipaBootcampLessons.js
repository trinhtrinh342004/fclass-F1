...
export const IPA_BOOTCAMP_CURRICULUM_MAP = [
  ...
  {
    lessonId: 3,
    topicEnglish: "Nguyên âm đơn 2",
    topicVietnamese: "Nguyên âm đơn 2",
  ...
  {
    lessonId: 4,
    topicEnglish: "Nguyên âm đôi",
    topicVietnamese: "Nguyên âm đôi",
    slug: "long-vowels",
    sourceLessons: [],
    status: "ready",
    notes: "Buổi 4 có structure riêng theo lesson source.",
  },
  {
    lessonId: 5,
    topicEnglish: "Phụ âm bật + âm bật đôi",
    topicVietnamese: "Phụ âm bật + âm bật đôi",
  ...
  },
  {
    lessonId: 6,
    topicEnglish: "Âm gió",
    topicVietnamese: "Âm gió",
    slug: "consonants-1-stop-sounds-and-nasals",
    sourceLessons: [],
    status: "ready",
    notes: "Buổi 6 có structure riêng theo lesson source.",
  },
  {
    lessonId: 7,
    topicEnglish: "Âm mũi + L/R + W/Y",
    topicVietnamese: "Âm mũi + L/R + W/Y",
    slug: "consonants-2-am-gio-va-am-kho-voi-nguoi-viet",
    sourceLessons: [],
    status: "ready",
    notes: "Buổi 7 dùng nội dung chi tiết từ lesson source.",
  },
  {
    lessonId: 8,
    topicEnglish: "Tổng ôn toàn bộ IPA",
    topicVietnamese: "Tổng ôn toàn bộ IPA",
...
export const IPA_BOOTCAMP_LESSONS = [
  ...
  createIpaLesson({
    id: 5,
    title: "Phụ âm bật + âm bật đôi",
    subtitle: "Phụ âm bật + âm bật đôi",
    topic: "Phụ âm bật + âm bật đôi",
