...
export const lesson01 = {
  ...
  alphabetFoundation: {
    ...
    imageGuess: [
      { icon: "🍎", answer: "A", options: ["A", "E", "O"] },
      { icon: "⚽", answer: "B", options: ["D", "B", "P"] },
      { icon: "🐱", answer: "C", options: ["C", "S", "G"] },
      { icon: "🐶", answer: "D", options: ["B", "T", "D"] },
      { icon: "🐟", answer: "F", options: ["V", "F", "S"] },
    ],
    missingLetters: [
    ...
    iconRead: [
      { icon: "🐱", prompt: "c _ t", answer: "a", options: ["a", "e", "o"] },
      { icon: "🐶", prompt: "d _ g", answer: "o", options: ["a", "o", "u"] },
      { icon: "🖊️", prompt: "p _ n", answer: "e", options: ["e", "i", "a"] },
      { icon: "☀️", prompt: "s _ n", answer: "u", options: ["o", "u", "a"] },
      { icon: "🐟", prompt: "f _ sh", answer: "i", options: ["e", "i", "o"] },
    ],
