  ...
  return (
    <main className="min-h-screen grid place-items-center bg-slate-50 px-4">
      <section className="w-full max-w-lg rounded-lg border bg-white p-6 text-center shadow-sm">
        <h1 className="text-2xl font-semibold text-slate-950">Tài khoản đã bị từ chối</h1>
        <p className="mt-3 text-slate-600">
          Tài khoản này không được phép vào lớp. Hãy liên hệ admin nếu đây là nhầm lẫn.
        </p>
